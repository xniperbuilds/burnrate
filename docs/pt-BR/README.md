...
A surpresa de sempre: **skills instaladas e não usadas pesam mais que o `CLAUDE.md`.** A descrição de cada skill carrega a cada turno, você a invoque ou não, então o `--startup` aponta as mais pesadas pelo nome.
